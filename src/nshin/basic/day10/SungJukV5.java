...
public class SungJukV5 {
    public static void main(String[] args) {
        ...
        // 클래스명 객체명 = new 클래스명()
        // 부모클래스명 객체명 = new 자식클래스명() (!! 더 선호)
        // Cat c = new Cat()
        // Animal cd = new Cat() (!! 더 선호)
        // cd = new Dog() (!!)
...
//보통 인터페이스의 명명법은 이름끝에 service르 추가함
...
class SungJukV5ServiceImpl implements SungJukV5Service {
    ...
    public SungJukVO readSungJuk() {
        ...
        return new SungJukVO(name,kor,eng,math);
    }
    ...
    public void printSungJuk(SungJukVO sj) {
            ...
            System.out.printf(fmt,
                    sj.getName(), sj.getKor(), sj.getEng(), sj.getMath(), sj.getTot(), sj.getAvg(), sj.getGrd());
        }
