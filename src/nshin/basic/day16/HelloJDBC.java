...
public class HelloJDBC {
    public static void main(String[] args) {
        ...
        // SQL문을 실행하고 관리하고자 할때 사용하는 표준 SQL 인터페이스
        // 이것을 통해 데이터베이스 코드를 한번만 작성해두면
        // 어떤 DBMS라도 코드 변경없이 동일하게 작동할 수 있음

        // JDK에 포함된 JDBC인터페이스는 java.sql 패키지 아래에 있음
        // 햐지만, 이것만으로 작동하지 않고 각 데이터베이스 제조사가
        // JDBC 인터페이스를 구현해서 작성항 클래스가 필요한데,
        // 이것을 JDBC 드라이버 매니저라 함.
        // JDBC 드라이버 매니저는 데이터베이스 제조사 홈페이지 에서 내려받을 수 있음.
        ...
        String ourl = "jdbc:oracle:thin:@192.168.74.3:1521:xe";
        String ousr = "system";
        ...
        // 4. vmware 에 구축된 postgre 서버 접속 테스트
        String pdrv = "org.postgresql.Driver";
        String purl = "jdbc:postgresql://192.168.74.3:5432/postgres";
