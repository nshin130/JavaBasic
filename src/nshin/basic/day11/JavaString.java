...
public class JavaString {
    public static void main(String[] args) {
        ...
        // 문자열을 나타내기 위해 c언어에서는 char 배열로 표현
        ...
        // java에서 String 객체는 메모리 재활용 => interning
        // 즉, 생성한 String 객체값은 String pool에 저장하는데
        ...
        if (str1 == str2)
            System.out.println("str1과 str2가 저장위치가 같음");
        if (str1 == str3)
        ...
        // i.g.) hello, java!!라는 문자열에서 각 단어의 첫글자를
        // 대문자로 만드는 코드를 작성해보세요
        String l= "hello, java!!";
        ...
        System.out.println(
                h.replace("자바","파이썬"));
        //String e = "123412341234"에서 12를 98로 변경
        System.out.println(e.replace("12","98"));

        String m = "1234-4567-9812"; //-룰 :으로 변경
        System.out.println(m.replace("-",":"));

        // i.g.) hello, java!!라는 문자열에서 각 단어의 첫글자만
        // 골라서 대문자로 만드는 코드를 작성해보세요
...
//        System.out.println((words[0].charAt(0)+"").replace("h","H"));
//        System.out.println((words[1].charAt(0)+"").replace("j","J"));
        ...
        // 화면에 출력하는데 사용하는 메서드임
        Date today = new Date(); //java.util import:option+enter

        // %tY : year %tm : month %td : day %tH : hour %tM : minute %tS: second
        // < : 변수 하나로 각각의 변수값들을 다 출한다는 뜻
        ...
        // 기존 공간에 새로 운 문자열을 바로 추가 할 수 있으므로
        // 메모를 절약할 수 있음
