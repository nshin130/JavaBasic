...
public class JavaLang {
    public static void main(String[] args) {
        ...
        // Object class
        // 모든 클래스의 조상
        // toString, equals, hashCode외 6개의 메서드가 정의되어 있음
        // 대다수 클래스는 Object 클래스가 제공하는
        // toString과 equals 메서드를 오버라이딩 해서 사용
        Member m = new Member();
        m.userid = "abc123";
        m.passwd = "987xyz";
        ...
        // 또한, 출력횟수가 여러번이면 코드를 종복 작성
        // => 클래스의 멤버변수를 출력할때는 toString 메서드 사용(ctrl+enter)
        //    예를 들어 변수가 하나 더 갑자기 추가되면
        ...
        // 모든 메서드가 static이기 때문에 객체를 생성없이 //static 무슨뜻
        // 바로 메서드 호출가능
        ...
        // i.g.) 3.1415926에서 round메서드를 이용해서
        // 소수점 2째 자리까지 구하려면?
