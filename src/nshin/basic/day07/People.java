...
public class People {
    ...
    //고객 클래스
    static class Person {
        //변수선언 (속성 property, 필드 field, 멤버 member)
        private String name;
        private String job;
        private int age;
    ...
    static class Student {
        ...
        public Student(String stunum, String name, String address, String bday, String major, String prof) {
            this.stunum = stunum;
            this.name =  name;
