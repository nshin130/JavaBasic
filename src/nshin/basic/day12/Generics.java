...
public class Generics {
    public static void main(String[] args) {
        ...
        // 컬렉션 클래스를 컴파일시 타입체크(자료형검사)를 해주는 기능

        // 즉, 클래스에 사용할 타입의 정보를 동적으로 넘겨줄 수
        // 실행시간(run time)에 발생할 수 있는 타입간 오류를 컴파일타임에
        // 발견할 수 있도록 해주는 기능이
        // JDK 1.5에서 부터 추가된 기능
        ...
        zoo2.add(new Lion() );
        //zoo2.add(new Tiger() );
        // 컴파일 할때 타입체크 가능 - zoo2에는 tiger 객체를 추가 못함
        ...
        // nums2라는 배열변수에는 String타임 값만 저장할 수 있음
