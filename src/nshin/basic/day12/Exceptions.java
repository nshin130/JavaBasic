...
public class Exceptions {
    public static void main(String[] args) throws IOException {
        ...
        // 오류는 시스템 단계에서 심각한 문제를
        // 야기해서 실행중인 프로그램을 강제로 종료시킴
...
//        System.out.println("프로그램 끝3");
        ...
        try {
            int g = 10, i = 0;
            int j = g / i;              // <- 오류발생
            System.out.println(j);      // 이코드는 실행안됨
        } catch (Exception ex) {
            //예외상황을 명확하게 지정하지 않음
            ex.printStackTrace();       // 예외발생시 어디서 발생했는지
            // 어떤 종류의 예외인지 알려줌
        }
        ...
        // 명시적인 예외처리를 강제함 (!!)
        // 예외발생 시점은 컴파일할때 compile time임
        // IOException
        // ClassNotFoundException

        // i.g.) 임의의 성적데이터(이름 국어 영어 수학)를
        // c:/Java/sungjuk.txt에 저장하는 프로그램 작성
        String sjdata = "혜교 98 45 23";
        String fpath = "/Users/nara/sungjuk.txt";
        ...
        try {
            ...
            e.printStackTrace();
        } // surround > catch 밖으로 빼고 fw는 안으로 넣어주기
