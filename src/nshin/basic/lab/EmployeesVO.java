...
public class EmployeesVO {
    ...
    //Constructor
    public EmployeesVO(String empno, String fname, String lname, String email, String phone, String hdate) {
        this.empno = empno;
        this.fname = fname;
        this.lname = lname;
        this.email = email;
    ...
    public String toString() {
        String fmt = "emp{ empno: %s, fname: %s, lname: %s, email: %s, phone: %s,\n +" +
                ", hdate: %s, jobid: %s, sal: %d, comm: %s, mgrid: %s, deptid: %s,";
    ...
    //ArrayList
//    public EmployeesVO(int empno, String fname, String lname, String email,
...
//    @Override
//    public String toString() {
//        return "Employees{" + "empno=" + empno + ", fname='" +
//                fname + '\'' + ", lname='" + lname + '\'' +
//                ", email='" + email + '\'' + ", phone='" +
//                phone + '\'' + ", hdate='" + hdate + '\'' + '}';
//    }
